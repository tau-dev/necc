...
IrRef genStackDealloc(IrBuild *, IrRef allocation);
...
IrRef genFLessThan(IrBuild *, IrRef, IrRef, u16 size);
IrRef genLessThanOrEquals(IrBuild *, IrRef, IrRef, u16 size, Signedness);
IrRef genFLessThanOrEquals(IrBuild *, IrRef, IrRef, u16 size);
IrRef genEquals(IrBuild *, IrRef, IrRef, u16 size, bool is_float);
